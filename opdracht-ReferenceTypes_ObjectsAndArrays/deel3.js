...
const lengthTemperCatThree = catBreeds[2].temperament.length;
console.log(catBreeds[2].temperament[lengthTemperCatThree - 1]); //console.log(catBreeds[2].temperament[4]);
